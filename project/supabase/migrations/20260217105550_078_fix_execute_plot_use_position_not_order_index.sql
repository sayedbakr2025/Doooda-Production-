/*
  # Fix execute_plot_transaction to use correct column name

  1. Problem
    - Function tries to insert into scenes.order_index
    - Actual column name is scenes.position
  
  2. Solution
    - Update INSERT statement to use 'position' instead of 'order_index'

  3. No breaking changes
    - Only fixes the column name mismatch
*/
